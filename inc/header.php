...
<?php if($config['consumer_key']){ ?>	<script type="text/javascript" src="http://platform.twitter.com/anywhere.js?id=<?php echo s($config['consumer_key']); ?>&amp;v=1"></script><?php echo "\n"; } ?>
